...
const testimonials = [
  {
    quote:
      "Synapse Studio has completely transformed my workflow. What used to take me hours now takes minutes with the AI tools.",
    author: "Alex Morgan",
  ...
  {
    quote:
      "The scene detection feature alone is worth the price. It's like having a professional editor working alongside you.",
    author: "James Wilson",
    role: "YouTuber",
  ...
  {
    quote:
      "As someone with no formal video editing experience, Synapse made it possible for me to create professional-looking content.",
    author: "Sarah Chen",
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full group hover:bg-white/5 transition-all duration-300"
                    >
                ...
                <div className="relative bg-black/60 backdrop-blur-sm border border-white/10 rounded-xl p-6 shadow-xl">
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex items-start">
                      <div className="w-8 h-8 rounded-full bg-purple-500/30 flex items-center justify-center text-white text-xs mr-3 mt-1">
                        A
                      </div>
                      <div className="bg-white/5 rounded-lg rounded-tl-none p-3 text-sm">
                        Just finished my first project with Synapse! The AI
                        scene detection is incredible.
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-8 h-8 rounded-full bg-blue-500/30 flex items-center justify-center text-white text-xs mr-3 mt-1">
                        T
                      </div>
                      <div className="bg-white/5 rounded-lg rounded-tl-none p-3 text-sm">
                        Has anyone tried the new voice-to-text feature? It's
                        saving me hours on subtitles!
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-8 h-8 rounded-full bg-green-500/30 flex items-center justify-center text-white text-xs mr-3 mt-1">
                        M
                      </div>
                      <div className="bg-white/5 rounded-lg rounded-tl-none p-3 text-sm">
                        I'm hosting a workshop on advanced Synapse techniques
                        next week. Join us!
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    <div className="flex -space-x-2 mr-4">
                      {[...Array(4)].map((_, i) => (
                        <div
                          key={i}
                          className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 flex items-center justify-center text-[10px] border border-black"
                        >
