...
export default function DepthEditor({ 
  ...
  // Generate with Flux Pro Depth
  const generateWithFluxProDepth = async () => {
    if (!prompt) return;
    ...
    try {
      ...
      console.error("Error generating with Flux Pro Depth:", error);
    } finally {
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 flex flex-col p-4">
        <div className="flex justify-between mb-4">
          <div className="flex gap-2">
            <h3 className="text-sm font-medium text-gray-300">Depth-Guided Generation</h3>
          </div>
          <div className="flex gap-2">
            <Button 
              variant="outline" 
        ...
        <div className="mb-4">
          <label className="text-sm text-gray-300 mb-1 block">Depth Strength: {depthStrength.toFixed(1)}</label>
          <Slider
      ...
      <div className="w-80 p-4 flex flex-col">
        ...
        <Textarea
          placeholder="Describe what you want to generate using depth information..."
        ...
        <Button
          ...
          onClick={generateWithFluxProDepth}
