      ...
      <div className="flex-1 flex flex-col p-4">
        <div className="flex justify-between mb-4">
          <div className="flex gap-2">
            <h3 className="text-sm font-medium text-gray-300">Variation Generation</h3>
          </div>
          <div className="flex gap-2">
            <Button 
              variant="outline" 
        ...
        <div className="mb-4">
          <label className="text-sm text-gray-300 mb-1 block">Variation Strength: {variationStrength.toFixed(1)}</label>
          <Slider
