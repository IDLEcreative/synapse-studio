...
const RESOLUTION_OPTIONS = [
  // Square formats
  { value: "square_hd", label: "Square HD (1024×1024)", aspectRatio: "1:1", resolution: "1024×1024" },
  { value: "square", label: "Square (512×512)", aspectRatio: "1:1", resolution: "512×512" },
  
  // Landscape formats
  { value: "landscape_16_9_hd", label: "Landscape 16:9 HD (1920×1080)", aspectRatio: "16:9", resolution: "1920×1080" },
  { value: "landscape_16_9", label: "Landscape 16:9 (1024×576)", aspectRatio: "16:9", resolution: "1024×576" },
  { value: "landscape_3_2", label: "Landscape 3:2 (1024×683)", aspectRatio: "3:2", resolution: "1024×683" },
  { value: "landscape_4_3", label: "Landscape 4:3 (1024×768)", aspectRatio: "4:3", resolution: "1024×768" },
  { value: "landscape_21_9", label: "Ultrawide 21:9 (1920×820)", aspectRatio: "21:9", resolution: "1920×820" },
  
  // Portrait formats
  { value: "portrait_9_16_hd", label: "Portrait 9:16 HD (1080×1920)", aspectRatio: "9:16", resolution: "1080×1920" },
  { value: "portrait_9_16", label: "Portrait 9:16 (576×1024)", aspectRatio: "9:16", resolution: "576×1024" },
  { value: "portrait_2_3", label: "Portrait 2:3 (683×1024)", aspectRatio: "2:3", resolution: "683×1024" },
  { value: "portrait_3_4", label: "Portrait 3:4 (768×1024)", aspectRatio: "3:4", resolution: "768×1024" },
  { value: "portrait_9_21", label: "Tall 9:21 (384×896)", aspectRatio: "9:21", resolution: "384×896" },
];

// Style presets for quick selection
const STYLE_PRESETS = [
  { value: "photorealistic", label: "Photorealistic", description: "Highly detailed and realistic imagery", prompt: "photorealistic, highly detailed, sharp focus, 8k resolution" },
  { value: "cinematic", label: "Cinematic", description: "Movie-like quality with dramatic lighting", prompt: "cinematic, film grain, dramatic lighting, shallow depth of field, movie still" },
  { value: "anime", label: "Anime", description: "Japanese animation style", prompt: "anime style, vibrant colors, clean lines, detailed" },
  { value: "digital_art", label: "Digital Art", description: "Modern digital illustration", prompt: "digital art, vibrant colors, detailed, illustration, trending on artstation" },
  { value: "oil_painting", label: "Oil Painting", description: "Traditional oil painting style", prompt: "oil painting, textured, detailed brushstrokes, artistic, canvas" },
  { value: "watercolor", label: "Watercolor", description: "Soft watercolor painting style", prompt: "watercolor painting, soft colors, flowing, artistic, paper texture" },
  { value: "3d_render", label: "3D Render", description: "Computer-generated 3D imagery", prompt: "3D render, octane render, global illumination, subsurface scattering, highly detailed" },
  { value: "pixel_art", label: "Pixel Art", description: "Retro pixel-based art style", prompt: "pixel art, 16-bit, retro game style, clear pixels, vibrant" },
  { value: "fantasy", label: "Fantasy", description: "Magical and fantastical imagery", prompt: "fantasy art, magical, ethereal, detailed, mystical, vibrant colors" },
  { value: "cyberpunk", label: "Cyberpunk", description: "Futuristic dystopian aesthetic", prompt: "cyberpunk, neon lights, futuristic, dystopian, high tech, low life, detailed" },
];
...
const PROMPT_TEMPLATES = [
  { 
    ...
    prompt: "Epic mountain landscape at sunset, golden hour lighting, majestic peaks, crystal clear lake reflection, dramatic clouds, photorealistic, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "landscape2", 
    category: "landscapes", 
    title: "Tropical Beach", 
    prompt: "Tropical beach paradise, crystal clear turquoise water, white sand, palm trees, sunny day, photorealistic, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1506953823976-52e1fdc0149a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "portrait1", 
    category: "portraits", 
    title: "Professional Portrait", 
    prompt: "Professional portrait of a person in business attire, neutral background, studio lighting, high quality, photorealistic, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "portrait2", 
    category: "portraits", 
    title: "Artistic Portrait", 
    prompt: "Artistic portrait with dramatic lighting, shallow depth of field, moody atmosphere, cinematic, photorealistic, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "concept1", 
    category: "concepts", 
    title: "Futuristic City", 
    prompt: "Futuristic city skyline, neon lights, flying vehicles, cyberpunk style, night scene, rain, reflections, detailed, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "concept2", 
    category: "concepts", 
    title: "Fantasy Castle", 
    prompt: "Fantasy castle on a floating island, magical atmosphere, waterfalls, dragons flying in the distance, sunset lighting, detailed, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1515890435782-59a5bb6ec191?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "product1", 
    category: "products", 
    title: "Product Showcase", 
    prompt: "Professional product photography of a sleek modern device on a minimalist background, studio lighting, commercial quality, photorealistic, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "product2", 
    category: "products", 
    title: "Food Photography", 
    prompt: "Gourmet food photography, professional lighting, shallow depth of field, appetizing, commercial quality, photorealistic, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "abstract1", 
    category: "abstract", 
    title: "Fluid Abstract", 
    prompt: "Abstract fluid art, vibrant colors, flowing patterns, high contrast, artistic, detailed, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1541701494587-cb58502866ab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
  { 
    id: "abstract2", 
    category: "abstract", 
    title: "Geometric Abstract", 
    prompt: "Abstract geometric composition, bold colors, sharp lines, minimalist style, detailed, 8k, ultra detailed",
    thumbnail: "https://images.unsplash.com/photo-1550859492-d5da9d8e45f3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=100&q=80"
  },
];
...
export default function FluxProEditor({ onComplete, proTools }: FluxProEditorProps) {
  ...
  const addPromptEnhancement = (suggestion: string) => {
    ...
    if (promptRef.current) {
      promptRef.current.focus();
      promptRef.current.setSelectionRange((prompt.trim() + ", " + suggestion).length, (prompt.trim() + ", " + suggestion).length);
    }
  };
  ...
  const loadFromPromptHistory = (historyItem: PromptHistoryItem) => {
    ...
    if (promptRef.current) {
      promptRef.current.focus();
      promptRef.current.setSelectionRange(historyItem.prompt.length, historyItem.prompt.length);
    }
  };
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const selectedResolution = RESOLUTION_OPTIONS.find(option => option.value === resolution);
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="p-4 bg-gray-900/30 rounded-lg mb-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() => {
                ...
                document.getElementById('text-to-image-container')?.classList.toggle('compact-view');
              }}
              title="Toggle compact view"
            >
              <LayoutIcon className="w-3.5 h-3.5 mr-1" />
              {document.getElementById('text-to-image-container')?.classList.contains('compact-view') 
                ? 'Expand' 
                : 'Compact'}
            </Button>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-4">
          ...
          <TabsContent value="simple">
            <div className="space-y-4">
              <div>
                ...
                {showPromptEnhancer && (
                  <div className="mt-2 p-3 bg-gray-800/50 rounded-md border border-gray-700">
                    <div className="flex justify-between items-center mb-2">
                      <h4 className="text-sm font-medium text-gray-300">Prompt Enhancers</h4>
                      <Button 
                        variant="ghost" 
                        size="sm" 
                        className="h-6 px-2 text-xs text-gray-400 hover:text-white"
                    ...
                    <div className="flex flex-wrap gap-1">
                      {PROMPT_ENHANCEMENT_SUGGESTIONS.map((suggestion, index) => (
                        <Button
                          key={index}
                          variant="outline"
                          size="sm"
                          className="text-xs py-1 px-2 h-auto bg-gray-800/50 hover:bg-gray-700/50"
                          onClick={() => addPromptEnhancement(suggestion.text)}
                        >
                          {suggestion.text}
                        </Button>
                      ))}
              ...
              <div>
                <Label htmlFor="negative-prompt" className="text-sm text-gray-300 mb-2 block">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
                  {STYLE_PRESETS.map((preset) => (
                    <Button
                      key={preset.value}
                      variant={selectedStyle === preset.value ? "default" : "outline"}
                      size="sm"
          ...
          <TabsContent value="builder">
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="action" className="text-sm text-gray-300 mb-2 block">
                  Action
                </Label>
                <Input
                  id="action"
              ...
              <div>
                <Label htmlFor="setting" className="text-sm text-gray-300 mb-2 block">
                  Setting
                </Label>
                <Input
                  id="setting"
              ...
              <div>
                <Label htmlFor="lighting" className="text-sm text-gray-300 mb-2 block">
                  Lighting
                </Label>
                <Input
                  id="lighting"
              ...
              <div>
                <Label htmlFor="style" className="text-sm text-gray-300 mb-2 block">
                  Style
                </Label>
                <Input
                  id="style"
              ...
              <div>
                <Label htmlFor="mood" className="text-sm text-gray-300 mb-2 block">
                  Mood
                </Label>
                <Input
                  id="mood"
              ...
              <div>
                <Label htmlFor="details" className="text-sm text-gray-300 mb-2 block">
                  Additional Details
                </Label>
                <Textarea
                  id="details"
        ...
        <div className="mb-6">
          <Label htmlFor="resolution" className="text-sm text-gray-300 mb-2 block">
            Resolution & Aspect Ratio
          </Label>
          <Select value={resolution} onValueChange={setResolution}>
            <SelectTrigger id="resolution" className="bg-gray-800/50 border-gray-700">
              <SelectValue placeholder="Select resolution" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="heading-square" disabled className="font-semibold text-gray-400">
                Square Formats
              </SelectItem>
              {RESOLUTION_OPTIONS.filter(option => option.aspectRatio === "1:1").map((option) => (
                <SelectItem key={option.value} value={option.value}>
                  {option.label}
                </SelectItem>
              ))}
              
              <SelectItem value="heading-landscape" disabled className="font-semibold text-gray-400 mt-2">
                Landscape Formats
              </SelectItem>
              ...
              <SelectItem value="heading-portrait" disabled className="font-semibold text-gray-400 mt-2">
                Portrait Formats
              </SelectItem>
              {RESOLUTION_OPTIONS.filter(option => option.value.startsWith("portrait_")).map((option) => (
                <SelectItem key={option.value} value={option.value}>
                  {option.label}
                </SelectItem>
              ))}
        ...
        <div className="mb-6">
          ...
          {enableSafetyChecker && (
            <div className="mt-2">
              <Label htmlFor="safety-tolerance" className="text-sm text-gray-300 mb-2 block">
                Safety Tolerance
              </Label>
              <Select value={safetyTolerance} onValueChange={setSafetyTolerance}>
                <SelectTrigger id="safety-tolerance" className="bg-gray-800/50 border-gray-700">
        ...
        {/* Output format */}
        <div className="mb-6">
          <Label htmlFor="output-format" className="text-sm text-gray-300 mb-2 block">
            Output Format
          </Label>
          <Select value={outputFormat} onValueChange={setOutputFormat}>
            <SelectTrigger id="output-format" className="bg-gray-800/50 border-gray-700">
      ...
      {generatedImages.length > 0 && (
        <div ref={resultContainerRef} className="p-6 bg-gray-900/30 rounded-lg">
          <h3 className="text-lg font-semibold mb-4 text-gray-200">Generated Images</h3>
          ...
          <div className="mt-4 p-3 bg-gray-800/50 rounded-md">
            <h4 className="text-sm font-medium text-gray-300 mb-1">Generation Details</h4>
